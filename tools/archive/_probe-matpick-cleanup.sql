...
INSERT INTO @docs (no) SELECT 单据编号 FROM rd_spec_doc_head WHERE 单据编号 IN (N'SD-2026-09-0038',N'SD-2026-09-0039',N'SD-2026-09-0040');
...
SELECT N'规格书残留' AS 检查, CAST(COUNT(*) AS nvarchar) AS n FROM rd_spec_doc_head WHERE 单据编号 IN (N'SD-2026-09-0038',N'SD-2026-09-0039',N'SD-2026-09-0040');
