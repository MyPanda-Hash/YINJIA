...
IF NOT EXISTS (SELECT 1 FROM yj_field WHERE panel_code='RD_PROGRESS' AND col_name=N'项目层级') INSERT INTO yj_field (panel_code, col_name, label, data_type, dict_sql, ref_panel, ref_field, display_field, place, seq, width, editable, required, hidden, visible) VALUES ('RD_PROGRESS', N'项目层级', N'项目层级', N'下拉框', N'SELECT v FROM (VALUES (N''一级''),(N''二级''),(N''三级''),(N''四级'')) AS t(v)', NULL, NULL, NULL, N'header', 40, 100, 1, 0, 0, 1);
