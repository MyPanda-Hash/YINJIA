...
| 研发管理 | 22 | 立项申请/项目实施计划 + 数据记录表 8(功能性滤效/碱性/矿化/抑菌/阻垢性能/RO保护/浸泡安全/压降精度) + 项目进度查询 + 产品文件 7(产品信息表/成型工艺清单/成型配方/规格书/组装BOM表/组装工艺清单/出货检验计划表) + 实验室使用记录表 4(加标水配置/内部委托测试申请/设备使用登记/仪器使用记录) |
| 仓库管理 | 1 | 库存状况 |
