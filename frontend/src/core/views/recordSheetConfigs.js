...
export const recordSheetConfigs = {
  ...
  // 组装BOM表:产品基本信息 + 修订记录/物料清单两块(30 种预置物料)
  RD_ASM_BOM: {
    headMode: 'report',
    staticTitle: '组装BOM表',
    ...
    dataTables: [
      { bar: '二、炭棒滤芯组装/包装物料清单', filterKey: '表区', filterVal: '物料清单', seedRows: [
          ...
          { key: '物料编号', label: '物料编号', w: 120 },
          { key: '物料规格', label: '物料规格', w: 320, area: true },
          { key: '外观要求', label: '外观要求', w: 300, area: true },
          { key: '用量', label: '用量', w: 80 },
        ]},
      { bar: '修订记录', filterKey: '表区', filterVal: '修订记录', cols: [
          { key: '表区', label: '表区', hiddenCol: true },
          { key: '序号', label: '序号', w: 60 },
          { key: '更改内容', label: '更改内容', w: 360, area: true },
  ...
  // 组装工艺清单:plain 清单(工序/控制内容/管控要求/检查比例);22 道工序预置
  RD_ASM_PROC: {
    headMode: 'plain',
  ...
  RD_SPEC_DOC: {
    ...
    dataTables: [
      { page: 1, bar: '修订记录（履历表）', filterKey: '表区', filterVal: '修订记录', cols: [
          { key: '表区', label: '表区', hiddenCol: true },
          { key: '序号', label: '序号', w: 60 },
    ...
    // 检验项目标准库(测试项目汇总.xlsx 26 类,勾选组装进检验要求)
    testLib: [
      { 检验项目: '外观', 检验要求: '裸棒要求：清洁、无破损无压痕，无裂纹、无倾斜等缺陷；切面平整无锯齿纹路，无明显缺角', 检验方法: '目视', 检验依据: '银嘉测试标准' },
      { 检验项目: '尺寸·产品尺寸', 检验要求: '外径：**±0.5mm；内径：**±0.5mm；长度：**±0.5mm', 检验方法: '游标卡尺', 检验依据: '银嘉测试标准' },
      { 检验项目: '尺寸·整体尺寸（包布/套网/套PP棉/打端盖）', 检验要求: '外径：**±0.5mm；内径：**±0.5mm；长度：**±0.5mm', 检验方法: '游标卡尺', 检验依据: '银嘉测试标准' },
      { 检验项目: '重量·炭棒重量（干重）', 检验要求: '**±*g', 检验方法: '电子秤', 检验依据: '银嘉测试标准' },
      { 检验项目: '重量·出货重量', 检验要求: '＞**g', 检验方法: '电子秤', 检验依据: '银嘉测试标准' },
      { 检验项目: '强度·抗压强度（裸棒）', 检验要求: '＞**kgf', 检验方法: '水平压板，间距**mm，下压速度5mm/min', 检验依据: '银嘉测试标准' },
      { 检验项目: '强度·跌落强度（裸棒）', 检验要求: '高度**cm，垂直跌落3次，炭棒无断裂', 检验方法: '**cm高处3次自由跌落', 检验依据: '银嘉测试标准' },
      { 检验项目: '强度·成品强度（一切二）', 检验要求: '高度**cm，垂直跌落3次，炭棒无断裂', 检验方法: '**cm高处3次自由跌落', 检验依据: '银嘉测试标准' },
      { 检验项目: '初始流速及压降·初始流速', 检验要求: '静态压力0.1Mpa条件下，初始流速＞**L/min', 检验方法: '可旋盖大T，0.1Mpa静态压力测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '初始流速及压降·压降', 检验要求: '测试流速**L/min，压降≤**kpa', 检验方法: '滤瓶进出水2分管连接测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '黑水及颗粒物·初始黑水', 检验要求: '轻微黑水，浊度≤20NTU', 检验方法: '按进水方向通水观察', 检验依据: '银嘉测试标准' },
      { 检验项目: '黑水及颗粒物·浸泡黑水及颗粒物', 检验要求: '浸泡2H：无肉眼可见黑水，浊度≤3NTU；颗粒物＜6颗', 检验方法: '浸泡测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '黄水测试', 检验要求: '初始：无肉眼可见黄水；浸泡隔夜（12-16H）：无肉眼可见黄水', 检验方法: '通水观察', 检验依据: '银嘉测试标准' },
      { 检验项目: '过滤精度·一级颗粒物去除率', 检验要求: '≥**%', 检验方法: '滤瓶测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '过滤精度·二级颗粒物去除率', 检验要求: '≥**%', 检验方法: '滤瓶测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '过滤精度·浊度去除率', 检验要求: '**%-**%', 检验方法: '浊度仪测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '隔夜浸泡口感/气味及浊度', 检验要求: '浸泡15-24H：出水无异味、口感正常，浊度值≤3NTU', 检验方法: '浸泡品尝', 检验依据: '银嘉测试标准' },
      { 检验项目: '浸泡口感测试', 检验要求: '浸泡24H，口感正常无异味', 检验方法: '浸泡品尝', 检验依据: '银嘉测试标准' },
      { 检验项目: '余氯·初始余氯去除率', 检验要求: '≥98%', 检验方法: '哈希分光光度计', 检验依据: '银嘉测试标准' },
      { 检验项目: '余氯·余氯寿命', 检验要求: '全程加标，寿命***L，去除率≥**%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'COD·初始COD去除率', 检验要求: '≥**%', 检验方法: 'COD测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'COD·COD寿命', 检验要求: '自来水点加标，寿命**L，COD去除率≥25%', 检验方法: '点加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '阻垢·初始阻垢率', 检验要求: '≥95%', 检验方法: '阻垢测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '阻垢·阻垢寿命', 检验要求: '自来水点加标，寿命**L，阻垢率≥25%', 检验方法: '点加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '抑菌·初始抑菌率', 检验要求: '≥99%', 检验方法: 'ASTME2149-13a 振荡接触24小时', 检验依据: '银嘉测试标准' },
      { 检验项目: '抑菌·抑菌寿命', 检验要求: '寿命**L，抑菌率≥90%', 检验方法: '寿命测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '过流杀菌·初始杀菌率', 检验要求: '≥**%', 检验方法: '过流杀菌测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '过流杀菌·杀菌寿命', 检验要求: '寿命**L，杀菌率≥**%', 检验方法: '寿命测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '碱性·初始碱性效果', 检验要求: '初始PH增加值：＞**', 检验方法: 'PH计测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '碱性·碱性寿命', 检验要求: '寿命**L，PH增加值≥**', 检验方法: '寿命测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '矿化·初始含量', 检验要求: '≥**mg/L', 检验方法: 'ICP-MS测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '矿化·矿化寿命', 检验要求: '≥**mg/L', 检验方法: '寿命测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'VOC·初始VOC去除率', 检验要求: '≥95%', 检验方法: 'VOC测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'VOC·除VOC寿命', 检验要求: '寿命**L，全程加标，去除率≥95%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '除铅·初始铅去除率（PH8.5&6.5）', 检验要求: '≥96.7%', 检验方法: 'ICP-MS测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '除铅·除铅寿命', 检验要求: '寿命**L，全程加标，去除率≥96.7%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '除汞·初始汞去除率（PH8.5&6.5）', 检验要求: '≥67%', 检验方法: 'ICP-MS测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '除汞·除汞寿命', 检验要求: '寿命**L，全程加标，去除率≥67%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'Cyst去除·初始去除率', 检验要求: '≥99.95%', 检验方法: 'Cyst测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'Cyst去除·除Cyst寿命', 检验要求: '寿命**L，全程加标，去除率≥99.95%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'PFOA&PFOS·初始去除率', 检验要求: '≥98.67%', 检验方法: 'PFOA&PFOS测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'PFOA&PFOS·除PFOA&PFOS寿命', 检验要求: '寿命**L，全程加标，去除率≥98.67%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'NSF401（三组）·初始去除率', 检验要求: '85%/86%（各项物质均能满足NSF401标准要求去除率）', 检验方法: 'NSF401测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'NSF401（三组）·除NSF401寿命', 检验要求: '寿命**L，全程加标，去除率85%/86%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '毒杀芬·初始去除率', 检验要求: '≥80%', 检验方法: '毒杀芬测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '毒杀芬·除毒杀芬寿命', 检验要求: '寿命**L，全程加标，去除率≥80%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'MTBE·初始去除率', 检验要求: '≥67%', 检验方法: 'MTBE测试', 检验依据: '银嘉测试标准' },
      { 检验项目: 'MTBE·除MTBE寿命', 检验要求: '寿命920L，全程加标，去除率≥67%', 检验方法: '全程加标测试', 检验依据: '银嘉测试标准' },
      { 检验项目: '卫生浸泡', 检验要求: '符合浸泡卫生要求', 检验方法: '参考GBT17219规范', 检验依据: '《生活饮用水输配水设备及防护材料卫生安全评价规范》' },
    ],
  },
  ...
  RD_INSP_PLAN: {
    ...
    dataTables: [
      { bar: '必测项', filterKey: '检验类别', filterVal: '必测项', cols: [
          { key: '表区', label: '表区', hiddenCol: true },
          { key: '检验类别', label: '检验类别', hiddenCol: true },
          { key: '控制项目', label: '控制项目', w: 130 },
          { key: '质量控制内容', label: '质量控制内容', w: 140 },
          { key: '检测仪器', label: '检测仪器、工具', w: 130 },
          { key: '控制标准及要求', label: '控制标准及要求', w: 340, area: true },
          { key: '检验', label: '检验', w: 70 },
          { key: '不合格应对措施', label: '不合格应对措施', w: 260, area: true },
          { key: '检测频率', label: '检测频率', w: 120 },
          { key: '取样方式', label: '取样方式', w: 110 },
          { key: '检验内容', label: '检验内容', w: 180 },
          { key: '控制方法', label: '控制方法', w: 110 },
        ]},
      { bar: '型式检验或者必测项', filterKey: '检验类别', filterVal: '型式检验', cols: [
          { key: '表区', label: '表区', hiddenCol: true },
          { key: '检验类别', label: '检验类别', hiddenCol: true },
          { key: '控制项目', label: '控制项目', w: 130 },
          { key: '质量控制内容', label: '质量控制内容', w: 140 },
