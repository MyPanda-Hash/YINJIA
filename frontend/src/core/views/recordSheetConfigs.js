  ...
  RD_ASM_BOM: {
    ...
    dataTables: [
      { bar: '二、炭棒滤芯组装/包装物料清单', filterKey: '表区', filterVal: '物料清单', seedRows: [
          ...
          { key: '物料名', label: '物料名' },
          { key: '物料编号', label: '物料编号' },
          { key: '物料规格', label: '物料规格', span: 2, area: true },
          { key: '外观要求', label: '外观要求' },
          { key: '用量', label: '用量' },
        ]},
      { bar: '修订记录', filterKey: '表区', filterVal: '修订记录', cols: [
          { key: '表区', label: '表区', hiddenCol: true },
          { key: '序号', label: '序号' },
          { key: '更改内容', label: '更改内容', span: 2, area: true },
          { key: '更改原因', label: '更改原因' },
          { key: '更改时间', label: '更改时间' },
          { key: '责任人', label: '责任人' },
        ]},
  ...
  RD_SPEC_DOC: {
    ...
    dataTables: [
      { page: 1, bar: '修订记录（履历表）', filterKey: '表区', filterVal: '修订记录', cols: [
          { key: '表区', label: '表区', hiddenCol: true },
          { key: '序号', label: '序号' },
          { key: '更改内容', label: '更改内容', span: 3, area: true },
          { key: '更改原因', label: '更改原因' },
          { key: '更改时间', label: '更改时间' },
          { key: '责任人', label: '责任人' },
          { key: '备注', label: '备注' },
      ...
      { page: 2, bar: '4.产品性能检验项目及检验标准', filterKey: '表区', filterVal: '检验要求', lib: true, cols: [
          { key: '表区', label: '表区', hiddenCol: true },
          { key: '序号', label: '序号' },
          { key: '检验项目', label: '检验项目', span: 2 },
          { key: '检验要求', label: '检验要求', span: 3, area: true },
          { key: '检验方法', label: '检验方法' },
          { key: '检验依据', label: '检验依据' },
        ]},
